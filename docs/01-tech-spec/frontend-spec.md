...
- Preference management UI for notification channels
...
- Polling only for operational statuses that are eventually consistent (e.g., latest delivery status)
...
- UI-level gating based on backend-provided capabilities (e.g., `canEnableSms`)
...
## 16. Frontend Logging and Diagnostics
...
## 18. Dependencies and Libraries
- Next.js, React, TypeScript
- TanStack Query
- React Hook Form + Zod
- Testing: Vitest/Jest + Playwright + Testing Library

## 19. Interfaces with UI/UX docs
- UX structure and journey references should come from `docs/02-ui-ux` artifacts (wireframes, flows, IA) once published.
...
- Gap: `docs/02-ui-ux` directory is currently absent in repository and should be created before design/interaction refinements.

## 20. Open Questions / Gaps
