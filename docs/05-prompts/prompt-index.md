...
## Purpose
This folder stores the single canonical prompt set used to generate and maintain repository documentation.
...
- `prototype-slice-extension-prompt.md`
...
## Incremental Build Prompt Track
Use the incremental prompt set to extend baseline product scope in small, testable slices:
- `docs/05-prompts/frontend-only-mock-first-development-prompt.md`
- `docs/05-prompts/prototype-slice-extension-prompt.md`

These prompts now live in the canonical prompt directory and should be used alongside product/design/execution prompts when planning phased delivery.
